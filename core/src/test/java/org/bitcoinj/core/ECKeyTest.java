...
public class ECKeyTest {
    ...
    public void base58Encoding() throws Exception {
        String addr = "qRAGAemcGKAjaTJbWBUnB8Hycg4qh4g85Y";
        String privkey = "cV3GzysWJTD7anPPqohuj8ZyWcEJUc9fC4bVNygn9xcjR2KZExJW";
    ...
    public void verifyMessage() throws Exception {
        ...
        String sigBase64 = "IH4GkrApkbKbrZ1AsXldyfUGv3GvSgFK+4OQwoPBMF1OfO0QGHU7y401If3NSqhZp5CwDAVae5yhWCAdyploZVU=";
        Address expectedAddress = LegacyAddress.fromBase58(MAINNET, "QTxkA1GY5tfYLy3JU3b5yYhetgaWWREkWy");
