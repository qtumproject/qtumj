...
public class PeerAddressTest {
    ...
    public void roundtrip_ipv4_addressV2Variant() throws Exception {
        ...
        MessageSerializer serializer = MAINNET.getDefaultSerializer().withProtocolVersion(NetworkParameters.ProtocolVersion.CURRENT.getQtumProtocolVersion());
    ...
    public void roundtrip_ipv6_addressV2Variant() throws Exception {
        ...
        MessageSerializer serializer = MAINNET.getDefaultSerializer()
                .withProtocolVersion(NetworkParameters.ProtocolVersion.CURRENT.getQtumProtocolVersion());
