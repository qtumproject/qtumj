...
public class BitcoinURITest {
    ...
    private static final String MAINNET_GOOD_ADDRESS = "Qeqn1rv8WmZMBPiQEV8y2n7pciTDim25mY";
    private static final String MAINNET_GOOD_SEGWIT_ADDRESS = "qc1qgcsd8tpj7k23k8grqx8lapx4aadr6hw5j6mp7t";
    ...
    public void testConvertToBitcoinURI() throws Exception {
        ...
        // simple example
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello&message=AMessage", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("12.34"), "Hello", "AMessage"));

        // example with spaces, ampersand and plus
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello%20World&message=Mess%20%26%20age%20%2B%20hope", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("12.34"), "Hello World", "Mess & age + hope"));

        // no amount, label present, message present
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?label=Hello&message=glory", BitcoinURI.convertToQtumURI(goodAddress, null, "Hello", "glory"));

        // amount present, no label, message present
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=0.1&message=glory", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("0.1"), null, "glory"));
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=0.1&message=glory", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("0.1"), "", "glory"));

        // amount present, label present, no message
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("12.34"), "Hello", null));
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("12.34"), "Hello", ""));

        // amount present, no label, no message
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=1000", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("1000"), null, null));
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?amount=1000", BitcoinURI.convertToQtumURI(goodAddress, parseCoin("1000"), "", ""));

        // no amount, label present, no message
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?label=Hello", BitcoinURI.convertToQtumURI(goodAddress, null, "Hello", null));

        // no amount, no label, message present
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?message=Agatha", BitcoinURI.convertToQtumURI(goodAddress, null, null, "Agatha"));
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS + "?message=Agatha", BitcoinURI.convertToQtumURI(goodAddress, null, "", "Agatha"));

        // no amount, no label, no message
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS, BitcoinURI.convertToQtumURI(goodAddress, null, null, null));
        assertEquals("qtum:" + MAINNET_GOOD_ADDRESS, BitcoinURI.convertToQtumURI(goodAddress, null, "", ""));
        ...
        assertEquals("test:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello&message=AMessage",
             BitcoinURI.convertToQtumURI(LegacyAddress.fromBase58(alternativeParameters, MAINNET_GOOD_ADDRESS), parseCoin("12.34"), "Hello", "AMessage"));
    }

    @Test
    public void testConvertToBitcoinURI_segwit() throws Exception {
        assertEquals("qtum:" + MAINNET_GOOD_SEGWIT_ADDRESS + "?message=segwit%20rules", BitcoinURI.convertToQtumURI(
    ...
    public void testGood_Combinations() throws BitcoinURIParseException {
        ...
        assertEquals(
                "QtumURI['amount'='654321000000000','label'='Hello World','message'='Be well','address'='Qeqn1rv8WmZMBPiQEV8y2n7pciTDim25mY']",
                testObject.toString());
    }
    ...
    public void testUnknown() throws BitcoinURIParseException {
        ...
        testObject = new BitcoinURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS
                + "?aardvark=true");
        assertEquals("QtumURI['aardvark'='true','address'='Qeqn1rv8WmZMBPiQEV8y2n7pciTDim25mY']", testObject.toString());
    ...
    public void brokenURIs() throws BitcoinURIParseException {
        ...
        String str = "qtum://Qeqn1rv8WmZMBPiQEV8y2n7pciTDim25mY?amount=0.01000000";
        BitcoinURI uri = new BitcoinURI(str);
        assertEquals("Qeqn1rv8WmZMBPiQEV8y2n7pciTDim25mY", uri.getAddress().toString());
    ...
    public void testPaymentProtocolReq() throws Exception {
        ...
        BitcoinURI uri = new BitcoinURI(TESTNET, "qtum:?r=https%3A%2F%2Fbitcoincore.org%2F%7Egavin%2Ff.php%3Fh%3Db0f02e7cea67f168e25ec9b9f9d584f9");
    ...
    public void testMultiplePaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(MAINNET,
                "qtum:?r=https%3A%2F%2Fbitcoincore.org%2F%7Egavin&r1=bt:112233445566");
    ...
    public void testNoPaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(MAINNET, "qtum:" + MAINNET_GOOD_ADDRESS);
    ...
    public void testUnescapedPaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(TESTNET,
                "qtum:?r=https://merchant.com/pay.php?h%3D2a8628fc2fbe");
